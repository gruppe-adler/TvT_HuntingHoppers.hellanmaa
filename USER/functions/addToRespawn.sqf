...
// opfor land vehicle
if (!_isAir) then {
    _vehicle addMagazineCargoGlobal ['hlc_30Rnd_545x39_EP_ak_Black', 20]; 
    _vehicle addMagazineCargoGlobal ['rhs_100Rnd_762x54mmR_green', 20];
    [_vehicle, _respawnInstant, 5, "(_this select 0) addMagazineCargoGlobal ['hlc_30Rnd_545x39_EP_ak_Black', 20]; 
